...
def get_train_test_split(data_path: str, output_dir: str, train_size: float = 0.8, stratify: bool = True, train_suffix: str = 'train', test_suffix: str = 'test') -> None:
    ...
    _write_train_and_test_data(data_path, output_dir, idxs_train, idxs_test, train_suffix, test_suffix)
...
def _write_train_and_test_data(data_path: str, output_dir: str, idxs_train: List[int], idxs_test: List[int], train_suffix: str, test_suffix: str) -> None:
